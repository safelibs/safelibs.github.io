...
This project wouldn't have happened with [Arizona State University's](https://asu.edu) experiment with giving each employee infinite codex usage for several months. Might be time to add another [#1 ranking](https://www.asu.edu/about/rankings) ;-)
